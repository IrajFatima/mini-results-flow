...
export default function AIRecommendationsPage() {
    ...
    return (
        <div className="min-h-screen bg-[#F8F4F4] dark:bg-[#181A1B] py-10">
            <div className="max-w-6xl mx-auto md:px-4 px-2">
                {/* Header */}
                <motion.div
                    initial={{ opacity: 0, y: -30 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="rounded-3xl bg-[#1F8A70] text-white p-5 md:p-10 shadow-xl"
                >
                ...
                >
                    <div className="flex justify-between items-center gap-3">
                        <h2 className="text-xl md:text-2xl font-bold text-[#183B49] dark:text-white">
                            Summary
                        </h2>
                        <span className={`md:px-4 md:py-2 px-2 py-1 text-xs text-center md:text-md rounded-full font-semibold ${assessment.color}`}>
                            {assessment.emoji} {report.overallAssessment}
                        </span>
                    </div>
                    <p className="mt-4 text-base md:text-lg leading-7 md:leading-8 text-gray-600 dark:text-gray-300">
                        {report.summary}
                    </p>
                </motion.div>
